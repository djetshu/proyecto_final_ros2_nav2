...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("position_x", default_value="13.9"),
        DeclareLaunchArgument("position_y", default_value="-10.6"),
        DeclareLaunchArgument("orientation_yaw", default_value="3.1416"),
